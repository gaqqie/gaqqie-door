...
class ProviderApi(object):
    ...
    def get_provider_by_name(self, name, **kwargs):  # noqa: E501
        """get_provider_by_name  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_provider_by_name(name, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_provider_by_name_with_http_info(name, **kwargs)  # noqa: E501
        else:
            (data) = self.get_provider_by_name_with_http_info(name, **kwargs)  # noqa: E501
            return data

    def get_provider_by_name_with_http_info(self, name, **kwargs):  # noqa: E501
        """get_provider_by_name  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_provider_by_name_with_http_info(name, async_req=True)
        >>> result = thread.get()
        ...
        if ('name' not in params or
                params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `get_provider_by_name`")  # noqa: E501
